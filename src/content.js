export const content = {
    1: {
        ...
        hasDemo: true,
        description: 'Drag and drop audio samples in order to create a song. Add cool effects and adjust the volume with a mixer board. Record your song in real-time and save it locally.',
    ...
    2: {
        demoLink: '',
        hasDemo: false,
        description: 'Pokémon app acting like a database by using the PokéAPI but with a focus on comparing multiple Pokémons stats with each other and displaying it as a chart for clarity.',
    ...
    3: {
        demoLink: '',
        hasDemo: false,
        description: 'Using the Spotify API together with Reddit\'s API in order to create playlists containing tracks from multiple subreddits. Also possible to replace individual tracks in a playlist.',
    ...
    4: {
        demoLink: '',
        hasDemo: false,
        description: 'Booking system for the Linnaues University. I was a part of the team that wrote the backend. Used the TimeEdit API in order to get any upcoming bookings for a grouproom.',
    ...
    5: {
        ...
        hasDemo: true,
        description: 'Track landing page for my music project A Himitsu. Averaging 8k track downloads per month.',
    ...
    6: {
        demoLink: '',
        hasDemo: false,
        description: 'View your organizations and subscribe to specific events to them in order to get real-time notifications when using the application or an email sent to you.',
